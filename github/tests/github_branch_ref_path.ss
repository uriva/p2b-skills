...
encodesSlashInBranchName = () => {
  ...
  assert({ condition: path == "/repos/uriva/p2b-skills/git/refs/heads/fix%2Fgithub-write", message: "expected branch ref path to use refs endpoint with encoded slash" })
  return true
}
